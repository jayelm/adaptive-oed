var infrastructure = function() {
	...
	var sts = [ { bright: [], hot: [], on: [] },
	  { bright: [], hot: [ 'bright' ], on: [] },
	  { bright: [], hot: [], on: [ 'bright' ] },
	  { bright: [], hot: [ 'bright' ], on: [ 'bright' ] },
	  { bright: [], hot: [], on: [ 'hot' ] },
	  { bright: [], hot: [ 'bright' ], on: [ 'hot' ] },
	  { bright: [], hot: [], on: [ 'bright', 'hot' ] },
	  { bright: [ 'hot' ], hot: [], on: [] },
	  { bright: [ 'hot' ], hot: [], on: [ 'hot' ] },
	  { bright: [ 'hot' ], hot: [], on: [ 'bright' ] },
	  { bright: [], hot: [ 'on' ], on: [] },
	  { bright: [], hot: [ 'on' ], on: [ 'bright' ] },
	  { bright: [], hot: [ 'bright', 'on' ], on: [] },
	  { bright: [ 'on' ], hot: [], on: [] },
	  { bright: [ 'on' ], hot: [ 'on' ], on: [] },
	  { bright: [ 'on' ], hot: [ 'bright' ], on: [] },
	  { bright: [ 'on' ], hot: [], on: [ 'hot' ] },
	  { bright: [ 'hot', 'on' ], hot: [], on: [] },
	  { bright: [ 'hot' ], hot: [ 'on' ], on: [] } ];
	var our1 = sts.slice(0, 4);
	var our2 = sts.slice(4, 8);
	var our3 = sts.slice(8, 12);
	var our4 = sts.slice(12, 16);
	var our5 = sts.slice(16, 19);
    // Sample a DAG
    var mSample = function() {
        // TODO: Sparsity! Factor by the number of connections?
        // No easy: assume flips @ some bernoulli
        var structAdjList = uniformDraw(our5);
